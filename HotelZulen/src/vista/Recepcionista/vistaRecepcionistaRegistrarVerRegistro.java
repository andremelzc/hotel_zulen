...
public class vistaRecepcionistaRegistrarVerRegistro extends javax.swing.JPanel {
    ...
    /**
     * Creates new form vistaRecepcionistaRegistrarVerRegistro
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, 400, 360));

        jButtonRegistrar.setBackground(new java.awt.Color(0, 102, 204));
        jButtonRegistrar.setForeground(new java.awt.Color(255, 255, 255));
        jButtonRegistrar.setText("Registrar Reserva");
        jButtonRegistrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonRegistrarActionPerformed(evt);
            }
        });
        jPanel1.add(jButtonRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 140, -1, 30));
